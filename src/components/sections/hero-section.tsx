    ...
    >
      <div className="container-width py-20">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1
            className="text-5xl md:text-6xl font-bold text-zinc-900 mb-6 leading-tight animate-fade-in-up"
            style={{ animationDelay: "100ms" }}
          >
            Septiya Yutantri
          </h1>
          <p
            className="text-xl md:text-2xl text-red-900 font-semibold mb-4 animate-fade-in-up"
            style={{ animationDelay: "200ms" }}
          >
            IT Service Management Officer | System Implementator
          </p>
          <p
            className="text-lg text-zinc-600 mb-8 max-w-2xl mx-auto animate-fade-in-up"
            style={{ animationDelay: "300ms" }}
          >
            Surabaya, Indonesia • Fast learner passionate about IT Service
            Management, System Implementation, and Business Process Analysis
          </p>
          <div
          ...
          <div
            className="mt-16 flex flex-col sm:flex-row justify-center gap-6 text-sm text-zinc-600 animate-fade-in-up"
